...
function setScoreData(data) {
    ...
    $('#nature_score, #connection-to-nature_modal_score').html(nature_score);
    ...
    $('#cultural_score, #cultural-fulfillment_modal_score').html(cultural_score);
    ...
    $('#leisure_score, #leisure-time_modal_score').html(leisure_score);
    ...
    $('#living_score, #living-standards_modal_score').html(living_score);
    ...
    $('#safety_score, #safety-and-security_modal_score').html(safety_score);
    ...
    $('#cohesion_score, #social-cohesion_modal_score').html(cohesion_score);

...
!(function(t, e) {
	'object' == typeof exports && 'undefined' != typeof module
		? (module.exports = e())
		: 'function' == typeof define && define.amd ? define(e) : ((t = t || self).ApexCharts = e());
})(this, function() {
	'use strict';
	function t(e) {
		return (t =
						...
						},
						{
							...
							value: function(t) {
								...
								return (
									...
									C.globals.dataChanged && E && M && z.animatePathsGradually(n({}, F, { speed: x })),
									I
								);
							}
						},
	...
	var p = {
									...
									if (null !== r) {
										...
										r.setAttribute('x', parseFloat(r.getAttribute('x')) - o.height + 4),
											'top' === t.label.position
												? r.setAttribute('y', parseFloat(r.getAttribute('y')) + o.width)
												: r.setAttribute('y', parseFloat(r.getAttribute('y')) - o.width);
						...
						value: function(t) {
							var e = t.params,
								...
								u = Object.assign(
									...
									'xaxis' === a
										? c.xAxisAnnotation
										: 'yaxis' === a ? c.yAxisAnnotation : c.pointAnnotation
								),
								g = d.extend(u, e);
							switch (a) {
								case 'xaxis':
					...
					},
					{
						...
						value: function(t, e, i, s, a, n, r) {
							var o = this.w,
								...
								m = d.fillPath({ seriesNumber: a, patternUnits: 'objectBoundingBox' }),
								v = x.drawCircle(i);
							if (
					...
					},
					{
						...
						value: function(t, e, i, s) {
							...
							return (
								...
								n.fillPath({ seriesNumber: this.barOptions.distributed ? o : s, color: r })
							);
						}
					},
					{
						...
						value: function(t) {
							...
							var k =
									a /
									y.config.chart.animations.animateGradually.delay *
							...
							for (
								...
								for (var M = 0; M < i.globals.dataPoints; M++) {
									i.config.stroke.show &&
										(C = this.isNullValue
											? 0
											: Array.isArray(this.strokeWidth) ? this.strokeWidth[w] : this.strokeWidth);
									var T = null;
									this.isHorizontal
										? ((T = this.drawBarPaths({
							...
							if (
								...
								b =
									this.prevYVal[u - 1][g] < 0
										? this.series[u][g] >= 0 ? w - v + 2 * (this.isReversed ? v : 0) : w
										: this.series[u][g] >= 0 ? w : w + v - 2 * (this.isReversed ? v : 0);
							...
							for (
								...
								for (
									...
									(u = T.pathTo),
										...
										P > 0 && m.push(p + A / 2),
										b.push(x);
									var X = a.fillPath({ seriesNumber: v, color: M }),
							...
							for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
								var c = i.group({
									class: 'apexcharts-series apexcharts-heatmap-series '.concat(
										d.escapeString(e.globals.seriesNames[h])
									),
									rel: h + 1,
									'data:realIndex': h
								});
							...
							for (var g = 0; g < t.length; g++) {
								var p = a.group({
									class: 'apexcharts-series apexcharts-pie-series '.concat(
										d.escapeString(i.globals.seriesNames[g])
									),
								...
								var x = h - o,
									b = n.fillPath({ seriesNumber: g, size: this.size }),
		...
		Y = (function() {
			function t(i) {
				...
				(this.size =
					this.defaultSize / 2.1 - s.config.stroke.width - s.config.chart.dropShadow.blur - n.width / 1.75),
									...
									var o = e.graphics
										...
										.attr({
											class: 'apexcharts-series '.concat(
												d.escapeString(i.globals.seriesNames[r])
											),
											rel: r + 1,
											'data:realIndex': r
										});
		...
		F = (function(t) {
			function i(t) {
				...
				return (
					...
					(s.fullAngle =
						360 - a.config.plotOptions.radialBar.endAngle - a.config.plotOptions.radialBar.startAngle),
							...
							for (var v = m ? t.series.length - 1 : 0; m ? v >= 0 : v < t.series.length; m ? v-- : v++) {
								var y = i.group({
									class: 'apexcharts-series apexcharts-radial-series '.concat(
										d.escapeString(e.globals.seriesNames[v])
									)
								});
								n.add(y),
								...
								if (
									(f.setAttrs(T.node, { 'data:angle': E, 'data:value': t.series[v] }),
		...
		D = (function() {
			function t(i, s, a) {
				e(this, t),
					...
					(this.xyRatios = s),
					(this.pointsChart =
						!('bubble' !== this.w.config.chart.type && 'scatter' !== this.w.config.chart.type) || a),
				...
				s(t, [
					{
						...
						value: function(t, e, i) {
							...
							for (
								...
								for (
									var $ = s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints,
										J = 0;
									J < $;
									J++
								) {
									...
									(N = tt.areaPaths),
										...
										(Y = tt.areaPath),
										(I = tt.linePath),
										this.appendPathFrom && ((F += a.line(T, E)), (R += a.line(T, E)));
								...
								t.config.yaxis.forEach(function(e, i) {
									void 0 !== e.labels.formatter
										...
										: (t.globals.yLabelFormatters[i] = function(i) {
												return d.isNumber(i)
													? 0 !== t.globals.yValueDecimal || t.globals.maxY - t.globals.minY < 4
														? i.toFixed(
				...
				s(t, [
					{
						...
						value: function(t, e) {
							var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
								...
								a = this.w,
								n =
									(void 0 === this.w.config.yaxis[i].max && void 0 === this.w.config.yaxis[i].min) ||
							...
							o < 1 &&
								...
								('candlestick' === a.config.chart.type ||
									'candlestick' === a.config.series[i].type ||
									a.globals.isRangeData) &&
								(e *= 1.01),
								o < 1e-5 && n && (e *= 1.05);
							var l = s + 1;
							l < 2 ? (l = 2) : l > 2 && (l -= 2);
										...
										? ((s.allSeriesCollapsed = !1),
											(void 0 === n.min && void 0 === n.max) || n.forceNiceScale
												? (s.yAxisScale[t] = this.niceScale(
														...
														i,
														t,
														n.tickAmount ? n.tickAmount : i < 5 && i > 1 ? i + 1 : 5
													))
					...
					},
					{
						...
						value: function() {
							...
							if (
								...
								var r =
									e.minX - e.svgWidth / e.dataPoints * (Math.abs(e.maxX - e.minX) / e.svgWidth) / 2;
								(e.minX = r), (e.initialminX = r);
								var o =
									e.maxX + e.svgWidth / e.dataPoints * (Math.abs(e.maxX - e.minX) / e.svgWidth) / 2;
					...
					},
					{
						...
						value: function(t) {
							return this.w.globals.dom.baseEl.querySelector(
								'.apexcharts-series.'.concat(d.escapeString(t))
							);
						}
					},
					{
				...
				s(t, [
					...
					},
					{
						...
						value: function(t) {
							...
							var h = 10;
							switch (((e.config.grid.show && 'radar' !== e.config.chart.type) || ((o = 0), (l = 35)),
					...
					},
					{
						...
						value: function() {
							...
							e.globals.isBarHorizontal &&
								...
								(i = e.globals.invertedTimelineLabels.slice());
							...
							return (
								1.05 *
									(t = new f(this.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize)).width *
									s.length >
									e.globals.gridWidth &&
							...
							var v = this.timeScaleArray.map(function(t) {
								...
								return 'month' === t.unit
									...
									: 'day' === t.unit || 'hour' === t.unit
										? n({}, e, { value: t.value })
										: 'minute' === t.unit ? n({}, e, { value: t.value, minute: t.value }) : t;
							});
						...
						value: function() {
							...
							(t.axisCharts =
								...
								(t.dom.elGraphical = t.dom.Paper
									.group()
									.attr({ class: 'apexcharts-inner apexcharts-graphical' })),
							...
							if (t.globals.isBarHorizontal) {
								...
								if (
									...
									if (t.globals.timelineLabels.length > 0)
										...
										for (var C = r, L = 0; L < C; L++) {
											var z = C;
											if (
												(t.globals.isXNumeric && 'bar' !== t.config.chart.type && (z -= 1),
											...
											if (t.config.grid.xaxis.lines.show) {
												...
												P.node.classList.add('apexcharts-gridline'),
													n.add(P),
													this.animX &&
														this.animateLine(P, { x1: 0, x2: 0 }, { x1: w, x2: y });
											}
											new H(this.ctx).drawXaxisTicks(w, s);
										}
								}
								if (t.config.grid.yaxis.lines.show)
									for (var E = 0, M = 0, T = t.globals.gridWidth, X = 0; X < o + 1; X++) {
										...
										a.add(I),
											I.node.classList.add('apexcharts-gridline'),
											this.animY &&
												this.animateLine(I, { y1: E + 20, y2: M + 20 }, { y1: E, y2: M }),
					...
					},
					{
						...
						value: function(t, e) {
							...
							if (i.globals.axisCharts || 'radialBar' === i.config.chart.type) {
								...
								i.globals.dom.Paper
									.select(" .apexcharts-series[rel='".concat(t + 1, "'] path"))
									.fire('click');
							}
						}
					},
					...
					},
					{
						...
						value: function(t) {
							...
							if (((this.clientY = c), (this.clientX = h), c < l.top || c > l.top + l.height))
								...
								if (
									(r.globals.isBarHorizontal && this.hasBars() && (g = !1),
										...
										if (null !== f) {
											...
											void 0 !== r.globals.series[f][e]
												? r.config.tooltip.shared &&
													...
													? this.create(a, this, f, e, n.ttItems)
													: this.create(a, this, f, e, n.ttItems, !1)
												: this.tooltipUtil.isXoverlap(e) &&
								...
								if (
									((s.clientX =
										'touchmove' === e.type || 'touchstart' === e.type
											? e.touches[0].clientX
											: 'touchend' === e.type ? e.changedTouches[0].clientX : e.clientX),
									(s.clientY =
										'touchmove' === e.type || 'touchstart' === e.type
											? e.touches[0].clientY
											: 'touchend' === e.type ? e.changedTouches[0].clientY : e.clientY),
				...
				(s.adopt = function(t) {
					return t
						? t.instance
							...
							: (((i =
									'svg' == t.nodeName
										? t.parentNode instanceof e.SVGElement ? new s.Nested() : new s.Doc()
										: 'linearGradient' == t.nodeName
											? new s.Gradient('linear')
											: 'radialGradient' == t.nodeName
												? new s.Gradient('radial')
												: s[d(t.nodeName)] ? new s[(d(t.nodeName))]() : new s.Element(t)).type =
									t.nodeName),
								(i.node = t),
								(t.instance = i),
			...
			(s.PathArray = function(t, e) {
					...
					extend: {
						...
						dequeue: function() {
							return (
								...
								this.situation &&
									(this.situation instanceof s.Situation ? this.start() : this.situation.call(this)),
								this
							);
						},
						...
						speed: function(t) {
							return 0 === t
								? this.pause()
								: t ? ((this._speed = t), this.at(this.absPos, !0)) : this._speed;
						},
						loop: function(t, e) {
							var i = this.last();
					...
					create: function(t, e) {
						return s.Color.isColor(e)
							...
							: s.regex.delimiter.test(t)
								? s.regex.pathLetters.test(t) ? new s.PathArray(t).morph(e) : new s.Array(t).morph(e)
				...
				s.extend(s.FX, {
					...
					viewbox: function(t, e, i, a) {
						return (
							this.target() instanceof s.Container && this.add('viewbox', new s.ViewBox(t, e, i, a)), this
						);
					},
					update: function(t) {
				...
				(s.Box = s.invent({
					create: function(e, i, a, n) {
						...
						4 == arguments.length && ((this.x = e), (this.y = i), (this.width = a), (this.height = n)),
							m(this);
					},
					extend: {
						merge: function(t) {
				...
				(s.Matrix = s.invent({
								...
								e instanceof s.Element
									...
									: 'string' == typeof e
										...
										: 6 == arguments.length
											...
											: Array.isArray(e) ? p(e) : 'object' === t(e) ? e : a,
								i = y.length - 1;
							i >= 0;
							--i
						)
					...
					extend: {
						...
						flip: function(t, e) {
							return 'x' == t
								? this.scale(-1, 1, e, 0)
								: 'y' == t ? this.scale(1, -1, 0, e) : this.scale(-1, -1, t, null != e ? e : t);
						},
				...
				(s.Point = s.invent({
					create: function(e, i) {
						...
						(s = Array.isArray(e)
							...
							: 'object' === t(e)
								? { x: e.x, y: e.y }
								: null != e ? { x: e, y: null != i ? i : e } : { x: 0, y: 0 }),
							(this.x = s.x),
							(this.y = s.y);
					},
					extend: {
						...
						if ('object' === t(e)) for (i in e) this.attr(i, e[i]);
							...
							if (null == i)
								return null == (i = this.node.getAttribute(e))
									? s.defaults.attrs[e]
									: s.regex.isNumber.test(i) ? parseFloat(i) : i;
							'stroke-width' == e
								...
								('fill' != e && 'stroke' != e) ||
									...
									i instanceof s.Image &&
										(i = this.doc().defs().pattern(0, 0, function() {
											this.add(i);
										}))),
								'number' == typeof i
									? (i = new s.Number(i))
							...
							: ((t = t || (this instanceof s.Doc ? this : this.parent(s.Parent))),
								...
								this.each(function() {
									return this instanceof s.Defs
										? this
										: this instanceof s.Parent ? this.ungroup(t, e - 1) : this.toParent(t);
								}),
								...
								'string' == typeof e
									...
									: Array.isArray(e)
										...
										: 'object' === t(e)
											...
											: 4 == arguments.length ? [].slice.call(arguments) : [ 0, 0, 0, 0 ]),
								(this.x = e[0]),
								(this.y = e[1]),
								(this.width = e[2]),
								(this.height = e[3]);
				...
				s.extend(s.Element, {
					...
					front: function() {
						var t = this.parent();
						return (
							t.node.appendChild(this.node), t instanceof s.Doc && t.node.appendChild(t.defs().node), this
						);
					},
					back: function() {
				...
				(s.Line = s.invent({
					...
					extend: {
						...
						plot: function(t, e, i, a) {
							return null == t
								? this.array()
								: ((t = void 0 !== e ? { x1: t, y1: e, x2: i, y2: a } : new s.PointArray(t).toLine()),
									this.attr(t));
						},
						move: function(t, e) {
					...
					data: function(e, i, s) {
						if ('object' === t(e)) for (i in e) this.data(i, e[i]);
							...
							this.attr(
								...
								null === i
									? null
									: !0 === s || 'string' == typeof i || 'number' == typeof i ? i : JSON.stringify(i)
							);
						return this;
					}
				}),
		...
		function() {
				...
				(SVG.Effect = SVG.invent({
					...
					extend: {
						in: function(t) {
							return null == t
								? (this.parent() &&
										this.parent().select('[result="' + this.attr('in') + '"]').get(0)) ||
									this.attr('in')
								: this.attr('in', t);
						},
						result: function(t) {
			...
			[ 'r', 'g', 'b', 'a' ].forEach(function(t) {
				...
				SVG.extend(SVG.CompositeEffect, SVG.BlendEffect, SVG.DisplacementMapEffect, {
					in2: function(t) {
						return null == t
							? (this.parent() && this.parent().select('[result="' + this.attr('in2') + '"]').get(0)) ||
								this.attr('in2')
							: this.attr('in2', t);
					}
				}),
		...
		(function() {
			...
			SVG.extend(SVG.PathArray, {
				morph: function(e) {
					...
					return (
						(this.value = i), (this.destination = new SVG.PathArray()), (this.destination.value = s), this
					);
				}
			});
		})(),
